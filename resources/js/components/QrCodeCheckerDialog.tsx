...
export function QrCodeCheckerDialog({ open, onOpenChange }: QrCodeCheckerDialogProps) {
    ...
    const handleReset = () => {
        ...
        setError(null);
        setCameraError(null);
        // The ref-callback will fire again when the <video> remounts
    };
        ...
        <Dialog open={open} onOpenChange={(v) => !v && onOpenChange(false)}>
            <DialogContent className="sm:max-w-lg">
                ...
                <div className="space-y-4 py-1">
                    {/* Camera viewfinder — hidden (not unmounted) once result/error shows */}
                    <div
                        ...
                        <div className="overflow-hidden rounded-xl border bg-card shadow-sm">
                            ...
                            <div className="grid grid-cols-2 divide-x border-t">
                                ...
                                <div className="px-4 py-3">
                                    ...
                                    <p className="mt-0.5 text-sm font-medium">
                                        {result.department?.shift
                                            ? `${result.department.shift.name} (${result.department.shift.start_time} – ${result.department.shift.end_time})`
                                            : '—'}
                                    </p>
                                </div>
                            </div>
